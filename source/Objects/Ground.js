...
define(["require", "exports", "./ObjectParent", "../Core/Core", "../CameraChar"], function (require, exports, ObjectParent_1, Core_1, CameraChar_1) {
    "use strict";
    /**
    ...
    var Ground = (function (_super) {
         ...
         */
        Ground.prototype.objectMatch = function (m, json) {
            if (json.g === "1") {
                // It's the ground
         ...
         *                   marked as this type of mesh.
         */
        Ground.prototype.objectNoMatch = function (m, json) {
        ...
        Ground.ensureCharAboveGround = function () {
            ...
            var pointAboveCamera = CameraChar_1.default.camera.position.add(new BABYLON.Vector3(0, 3, 0));
            // Cast a ray straight down from that point, and get the point
            // where that ray intersects with the ground.
            var groundPt = Core_1.default.scene.pickWithRay(new BABYLON.Ray(pointAboveCamera, new BABYLON.Vector3(0, -0.1, 0))).pickedPoint;
            // Get a point in 3D space that is three feet above the camera.
            var pointBelowCamera = CameraChar_1.default.camera.position.subtract(new BABYLON.Vector3(0, 3, 0));
            ...
            if (groundPt === null) {
                ...
                // where that ray intersects with the ground.
                var groundPt_1 = Core_1.default.scene.pickWithRay(new BABYLON.Ray(pointBelowCamera, new BABYLON.Vector3(0, 0.1, 0))).pickedPoint;
            }
            ...
            if (groundPt !== null) {
                ...
                var feetAltitude = CameraChar_1.default.feetAltitude();
                ...
                if (groundAltitude > feetAltitude) {
                    ...
                    CameraChar_1.default.camera.position.y =
                        CameraChar_1.default.camera.position.y - delta;
                }
            }
            else {
            }
