    ...
    function loadPDBURL(url, callBack) {
        jQuery.ajax(url, {
            "success": function (data) {
                ...
                exports.viewer.addModel(data, "pdb");
                // viewer.zoomTo();
    ...
    function buildStylesSubMenu() {
        ...
        var _loop_1 = function (i1) {
            if (components.hasOwnProperty(i1)) {
                var component_1 = components[i1];
                menu[component_1] = {};
                var _loop_2 = function (i2) {
                    if (selections[component_1].hasOwnProperty(i2)) {
                        var selection_1 = selections[component_1][i2];
                        menu[component_1][selection_1] = {};
                        var _loop_3 = function (i3) {
                            if (representations[component_1].hasOwnProperty(i3)) {
                                var rep_1 = representations[component_1][i3];
                                menu[component_1][selection_1][rep_1] = {};
                                var _loop_4 = function (i4) {
                                    if (colorSchemes.hasOwnProperty(i4)) {
                                        var colorScheme_1 = colorSchemes[i4];
                                        menu[component_1][selection_1][rep_1][colorScheme_1] = function () {
                                            Visualize.toggleRep([component_1, selection_1], rep_1, colorScheme_1);
                                            Menu3D.openMainMenuFloorButton.toggled();
                                        };
                                    }
                                };
                                for (var i4 in colorSchemes) {
                                    _loop_4(i4);
                                }
                            }
                        };
                        for (var i3 in representations[component_1]) {
                            _loop_3(i3);
                        }
                    }
                };
                for (var i2 in selections[component_1]) {
                    _loop_2(i2);
                }
            }
        };
        for (var i1 in components) {
            _loop_1(i1);
        }
        return menu;
    }
...
define('UI/Menu3D/Menu3D',["require", "exports", "../../Cameras/CommonCamera", "../../Navigation/Points", "../../Vars", "./Button", "./Rotations", "./Styles"], function (require, exports, CommonCamera, VRPoints, Vars, Button, Rotations, Styles) {
    ...
    function setupMainMenu(data) {
        ...
        var menuData = groupMenuInfByLevel();
        ...
        // previously.
        menuData = setupSubMenuNavButtons(menuData);
...
define('Mols/3DMol/ThreeDMol',["require", "exports", "../CommonLoader", "./Visualize", "./VRML"], function (require, exports, CommonLoader, Visualize, VRML) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    function after3DMolJsLoaded(sceneInfoData) {
        VRML.setup(function () {
            ...
            VRML.loadPDBURL(pdbUri, function () {
