...
(function(){var x,u,n;(function(w){function a(a,c){var r,b;c=c&&c.split("/");var d=q.map,f=d&&d["*"]||{};if(a){a=a.split("/");var k=a.length-1;q.cb&&e.test(a[k])&&(a[k]=a[k].replace(e,""));"."===a[0].charAt(0)&&c&&(k=c.slice(0,c.length-1),a=k.concat(a));for(k=0;k<a.length;k++){var l=a[k];"."===l?(a.splice(k,1),--k):".."===l&&0!==k&&(1!==k||".."!==a[2])&&".."!==a[k-1]&&0<k&&(a.splice(k-1,2),k-=2)}a=a.join("/")}if((c||f)&&d){l=a.split("/");for(k=l.length;0<k;--k){var t=l.slice(0,k).join("/");if(c)for(b=
c.length;0<b;--b)if(r=d[c.slice(0,b).join("/")])if(r=r[t]){var h=r;var v=k;break}if(h)break;if(!y&&f&&f[t]){var y=f[t];var g=k}}!h&&y&&(h=y,v=g);h&&(l.splice(0,v,h),a=l.join("/"))}return a}function g(a,c){return function(){var r=v.call(arguments,0);"string"!==typeof r[0]&&1===r.length&&r.push(null);return p.apply(w,r.concat([a,c]))}}function f(c){return function(r){return a(r,c)}}function h(a){return function(c){d[a]=c}}function b(a){if(k.call(c,a)){var r=c[a];delete c[a];t[a]=!0;A.apply(w,r)}if(!k.call(d,
a)&&!k.call(t,a))throw Error("No "+a);return d[a]}function m(a){var c=a?a.indexOf("!"):-1;if(-1<c){var e=a.substring(0,c);a=a.substring(c+1,a.length)}return[e,a]}function l(a){return function(){return q&&q.M&&q.M[a]||{}}}var p,d={},c={},q={},t={},k=Object.prototype.hasOwnProperty,v=[].slice,e=/\.js$/;var y=function(c,e){c=m(c);var k=c[0];e=e[1];c=c[1];if(k){k=a(k,e);var d=b(k)}k?d&&d.normalize?c=d.normalize(c,f(e)):c=a(c,e):(c=a(c,e),c=m(c),k=c[0],c=c[1],k&&(d=b(k)));return{ga:k?k+"!"+c:c,n:c,fb:k,
p:d}};var z={require:function(a){return g(a)},G:function(a){var c=d[a];return"undefined"!==typeof c?c:d[a]={}},Ma:function(a){return{id:a,uri:"",G:d[a],M:l(a)}}};var A=function(a,e,f,l){var q,v=[];var r=typeof f;var p=(l=l||a)?m(l):[];if("undefined"===r||"function"===r){e=!e.length&&f.length?["require","exports","module"]:e;for(q=0;q<e.length;q+=1){var A=y(e[q],p);r=A.ga;if("require"===r)v[q]=z.require(a);else if("exports"===r){v[q]=z.G(a);var B=!0}else if("module"===r)var n=v[q]=z.Ma(a);else if(k.call(d,
r)||k.call(c,r)||k.call(t,r))v[q]=b(r);else if(A.p)A.p.load(A.n,g(l,!0),h(r),{}),v[q]=d[r];else throw Error(a+" missing "+r);}e=f?f.apply(d[a],v):void 0;a&&(n&&n.G!==w&&n.G!==d[a]?d[a]=n.G:e===w&&B||(d[a]=e))}else a&&(d[a]=f)};x=u=p=function(a,c,e,k,d){if("string"===typeof a)return z[a]?z[a](c):b(y(a,c?m(c):[]).ga);if(!a.splice){q=a;q.Ca&&p(q.Ca,q.$a);if(!c)return;c.splice?(a=c,c=e,e=null):a=w}c=c||function(){};"function"===typeof e&&(e=k,k=d);k?A(w,a,c,e):setTimeout(function(){A(w,a,c,e)},4);return p};
...
function(n,a,g,f,h,b,m,l){function p(){v=g.m();b.a.registerBeforeRender(function(){var a=g.m();null===l.Ha(a).pickedMesh?g.pa(v):v=a})}function d(){jQuery("body").keypress(function(a){32===a.charCode&&c()})}function c(){var a=(new Date).getTime();if(!(250>a-e))switch(e=a,console.log("hi"),m.Fa()){case 2:console.log("teleport");q();break;case 4:t();break;case 3:m.s.v()}}function q(a,c){void 0===a&&(a=void 0);void 0===c&&(c=void 0);void 0===c&&(c=function(){});b.f.gazeTrackerMesh.isVisible=!1;var e=
new BABYLON.Animation("animationCameraTeleportation","position",90,BABYLON.Animation.ANIMATIONTYPE_VECTOR3,BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT),d=g.m();void 0===a&&(a=new BABYLON.Vector3(l.h.x,l.h.y+b.L,l.h.z));var k=g.Ga();a=a.subtract(k);d=d.subtract(k);e.setKeys([{frame:0,value:d},{frame:b.ba,value:a}]);var f=b.a.activeCamera;f.animations=[];f.animations.push(e);b.a.beginAnimation(f,0,b.ba,!1,1,function(){b.f.gazeTrackerMesh.isVisible=!0;f.animations=[];c()})}function t(){var a=l.X,c=
g.m(),e=l.h.subtract(c),d=e.length(),k;.1*d<b.aa?k=l.h.subtract(e.normalize().scale(b.aa)):.1*d>b.T?k=l.h.subtract(e.normalize().scale(b.T)):.1*d<b.T&&(k=c.add(e.scale(.9)));k.y=l.h.y;k.y-a.y<.5*b.S+.1&&(k.y=a.y+.5*b.S+.1);b.Qa(l.h.y-a.y);q(k,function(){f.Pa()})}function k(){y=jQuery("#capture-clicks");y.click(function(){console.log("clicked!");c()});b.a.registerBeforeRender(function(){var a=b.a.activeCamera.inputs.attached.deviceOrientation;(a=a?0!==a._alpha||0!==a._beta||0!==a._gamma:!1)&&!z?(z=
...
g.m()});l.push(a.w)}});n("Cameras/VRControllers","require exports ../Navigation/Navigation ../Navigation/Pickables ../Navigation/Points ../Vars ./CommonCamera ./VRCamera".split(" "),function(n,a,g,f,h,b,m,l){function p(a){a.onTriggerStateChangedObservable.add(function(a){a.pressed&&(a=(new Date).getTime(),a-c>b.xa&&(c=a,g.ca()))})}function d(a){a.onPadStateChangedObservable.add(function(a){(v=a.pressed)&&Math.abs(t)<b.J&&Math.abs(k)<b.J&&console.log("Would reset camera view if you didn't get an error below...")});
a.onPadValuesChangedObservable.add(function(a){t=a.y;k=a.x;Math.abs(k)<b.J&&Math.abs(t)<b.J?k=t=0:.5>Math.abs(k)?k=0:(k+=0<k?-.5:.5,k=2*k)});b.a.registerBeforeRender(function(){if(v){if(!h.h.equals(h.H)){var a=m.m(),e=h.h.subtract(a);e.normalize();e=e.scale(t*b.ua*b.a.getAnimationRatio());m.pa(a.subtract(e))}0!==k&&(a=(new Date).getTime(),a-q<b.wa||(q=a,a=b.f.webVRCamera.rotationQuaternion.toEulerAngles(),a.y+=.25*Math.sign(k)*Math.PI,b.f.webVRCamera.rotationQuaternion=BABYLON.Quaternion.FromEulerVector(a)))}})}
Object.defineProperty(a,"__esModule",{value:!0});var c=0,q=0,t=0,k=0,v=!1;a.c=function(){f.La();b.f.webVRCamera.onControllerMeshLoadedObservable.add(function(a){b.b.g=1;console.log("controller loaded");l.Ra();console.log("Isnt there on pickable or something");p(a);d(a)})}});n("Cameras/VRCamera","require exports ../Navigation/Pickables ../Scene/Optimizations ../Vars ./VRControllers".split(" "),function(n,a,g,f,h,b){function m(){h.f.onEnteringVRObservable.add(function(){h.b.g=2;p();g.C(void 0);f.I();
...
e.minimumWorld[a]});var d=a.getBoundingInfo().boundingBox,k=Object.keys(d.maximumWorld).map(function(a){return d.maximumWorld[a]-d.minimumWorld[a]});b=b.map(function(a,b){return a/k[b]});b=Math.min.apply(null,b);c=new BABYLON.Vector3(b,b,b);a.scaling=c;f.a.render();q=d.centerWorld.subtract(e.centerWorld)}else a.scaling=c;a.position=a.position.subtract(q);g.I()}}Object.defineProperty(a,"__esModule",{value:!0});var d=[],c,q,t,k;a.c=function(){jQuery("body").append('<div\n        id="mol-container"\n        class="mol-container"\n        style="display:none;"></div>');
var b=jQuery("#mol-container");a.u=$3Dmol.createViewer(b,{backgroundColor:"white"});window.viewer=a.u};a.Ia=function(b){jQuery.ajax("https://files.rcsb.org/view/1XDN.pdb",{success:function(c){a.u.addModel(c,"pdb");b()},error:function(a,b,c){console.error("Failed to load PDB https://files.rcsb.org/view/1XDN.pdb: "+c)}})};a.render=function(b,c){void 0===b&&(b=!0);void 0===c&&(c=function(){});f.l.hideLoadingUI();a.u.render();b&&(t=a.u.exportVRML(),m(function(){var a=l();p(a,f.a.getMeshByName("protein_box"));
c(a);d=[]}))};a.bb=l;a.eb=p});n("Mols/3DMol/Visualize",["require","exports","../../Scene/Optimizations","./VRML"],function(n,a,g,f){function h(a){f.render(!0,function(b){for(var c in l)if(l.hasOwnProperty(c)){var d=l[c];d.B===a.B&&(g.Oa(d.mesh),delete l[c],console.log("deleting old mesh..."))}l[a.V]={B:a.B,mesh:b};console.log("added new mesh");console.log(l)})}function b(a,b,d){a.sort();return{B:a.join("-")+"-"+b,V:a.join("-")+"-"+b+"-"+d}}function m(a){var b=a.map(function(a){return a}),c;for(c in a)if(a.hasOwnProperty(c)){var d=
a[c];b.push(d.toUpperCase());b.push(d.toLowerCase())}return b=b.filter(function(a,c){return b.indexOf(a)>=c})}Object.defineProperty(a,"__esModule",{value:!0});var l={},p={All:{},Protein:{resn:m("ALA ARG ASP ASN ASX CYS GLN GLU GLX GLY HIS HSP HYP ILE LEU LYS MET PCA PHE PRO TRP TYR VAL GLU SER THR MSE".split(" "))},Acidic:{resn:m(["ASP","GLU"])},Cyclic:{resn:m(["HIS","PHE","PRO","TRP","TYR"])},Aliphatic:{resn:m(["ALA","GLY","ILE","LEU","VAL"])},Aromatic:{resn:m(["HIS","PHE","TRP","TYR"])},Basic:{resn:m(["ARG",
"HIS","LYS","HSP"])},Charged:{resn:m("ASP GLU ARG HIS LYS HSP".split(" "))},Hydrophobic:{resn:m("ALA LEU VAL ILE PRO PHE MET TRP".split(" "))},Neutral:{resn:m("VAL PHE GLN TYR HIS CYS MET TRP ASX GLX PCA HYP".split(" "))},Nucleic:{resn:m("ADE A GUA G CYT C THY T URA U".split(" "))},Purine:{resn:m(["ADE","A","GUA","G"])},Pyrimidine:{resn:m("CYT C THY T URA U".split(" "))},Ions:{resn:m("AL BA CA CAL CD CES CLA CL CO CS CU CU1 CUA HG IN IOD K MG MN3 MO3 MO4 MO5 MO6 NA NAW OC7 PB POT PT RB SOD TB TL WO4 YB ZN ZN1 ZN2".split(" "))},
Water:{resn:m(["WAT","HOH","TIP","TIP3"])}};p.Ligand={not:{or:[p.Protein,p.Nucleic,p.Ions,p.Water]}};var d={Element:{colorscheme:"default"},Red:{color:"red"},Blue:{color:"blue"},Green:{color:"green"},Orange:{color:"orange"},Yellow:{color:"yellow"},Purple:{color:"purple"},Spectrum:{color:"spectrum"}};a.Ya=function(a,g,m){var c=b(a,g,m);if("Hide"===m)for(var n in l)l.hasOwnProperty(n)&&(g=l[n],g.B===c.B&&(g.mesh.isVisible=!1,console.log("Hiding existing mesh...")));else void 0!==l[c.V]?(l[c.V].mesh.isVisible=
!0,console.log("showing existing mesh...")):(f.u.setStyle({}),n=d[m],a={and:a.map(function(a){return p[a]})},"surface"===g.toLowerCase()?f.u.addSurface($3Dmol.SurfaceType.MS,n,a,void 0,void 0,function(){h(c)}):(m={},m[g.toLowerCase()]=n,f.u.addStyle(a,m),h(c)))}});n("UI/Menu3D","require exports ../Cameras/CommonCamera ../Mols/3DMol/Visualize ../Navigation/Pickables ../Navigation/Points ../Vars".split(" "),function(n,a,g,f,h,b,m){function l(){function a(a){if(b.hasOwnProperty(a)){e[a]=new BABYLON.GUI.SpherePanel;
...
for(var c in b)a(c)}function p(){function a(e,f,g){function k(d){if(h.hasOwnProperty(d)){d=h[d];var k=e[d];c[f]=void 0===c[f]?[]:c[f];switch(typeof k){case "function":c[f].push({P:k,D:d,F:g});break;case "object":var l=b(f+1);c[f].push({color:r,P:function(){q(l)},D:d+" \u21e8",F:g});a(k,l,f);break;default:alert("error!")}}}d.push(f);var h=Object.keys(e),l;for(l in h)k(l)}function b(a){for(;-1!==d.indexOf(a);)a++;return a}var c={},d=[];a(t,1,void 0);return c}function d(a){function b(b){if(a.hasOwnProperty(b)){a[b].sort(function(a,
b){return(""+a.D).localeCompare(b.D)});var c=+b;1<c&&a[b].push({color:B,P:function(){q(a[b][0].F)},D:"Back \u21e6",F:a[b][0].F});0<c&&a[b].push({color:G,P:function(){x.Z()},D:"Close Menu \u00d7",F:a[b][0].F})}}for(var c in a)b(c);console.log(a);return a}function c(){var a=new BABYLON.GUI.StackPanel3D;v.addControl(a);x=new C({v:function(a){a.value?q(1):q(0);w.position.copyFrom(g.m());w.rotation.y=g.ia()},default:!1,O:"Show Menu",level:0,name:"menu-visible-button",oa:a,R:"Hide Menu"});var c=new BABYLON.TransformNode("");
a.linkToTransformNode(c);c.rotation.x=.5*Math.PI;m.a.registerBeforeRender(function(){c.position.copyFrom(b.W);c.position.y+=.1;c.rotation.y=g.ia()})}function q(a){for(var b in k)if(k.hasOwnProperty(b)){var c=k[b];0===c.level?c.isVisible(!0):c.level===a?c.isVisible(!0):c.isVisible(!1)}}Object.defineProperty(a,"__esModule",{value:!0});var t=function(){function a(a){if(b.hasOwnProperty(a)){var d=b[a];k[d]={};a=function(a){if(c[d].hasOwnProperty(a)){var b=c[d][a];k[d][b]={};a=function(a){if(e[d].hasOwnProperty(a)){var c=
e[d][a];k[d][b][c]={};a=function(a){if(g.hasOwnProperty(a)){var e=g[a];k[d][b][c][e]=function(){f.Ya([d,b],c,e);x.Z()}}};for(var h in g)a(h)}};for(var h in e[d])a(h)}};for(var h in c[d])a(h)}}var b=["Protein","Ligand","Water","Nucleic"],c={Ligand:["All"],Nucleic:["All"],Protein:["All","Hydrophobic","Hydrophilic","Charged","Aromatic"],Water:["All"]},d=["Stick","Sphere","Surface"],e={Ligand:d,Nucleic:d,Protein:["Cartoon"].concat(d),Water:d},g="Element Red Blue Green Orange Yellow Purple Spectrum Hide".split(" "),
k={},h;for(h in b)a(h);return k}(),k=[],v,e={},w,u,x,r=new BABYLON.Color3(.3,.35+.1,.4),B=new BABYLON.Color3(.4,.35+.1,.4),G=new BABYLON.Color3(.4,.35,.4);a.c=function(a){l(a);c();u=new BABYLON.Sound("click-button","assets/staple-public-domain.mp3",m.a,null,{loop:!1,autoplay:!1,ib:!0,volume:.1})};var C=function(){function a(a){var b=this;this.button=new BABYLON.GUI.HolographicButton(a.name);a.oa.addControl(this.button);if(void 0!==a.color){var c=this.button.mesh.material.clone();c.albedoColor=a.color;
...
a.loaded/a.total).toString()+"%")})}Object.defineProperty(a,"__esModule",{value:!0});a.load=function(){d.c();l.Na();q();t(function(){g.c();b.c();m.c();p.c();h.c()});window.addEventListener("resize",function(){d.l.resize()})};a.Ka=function(){setTimeout(c.I,1E3);l.Xa();d.a.activeCamera.maxZ=250;d.a.activeCamera.minZ=0;d.l.runRenderLoop(function(){d.a.render()})}});u.M({urlArgs:"bust="+(new Date).getTime()});u(["Scene/LoadAndSetup"],function(n){n.load()});n("Start",function(){})})();
