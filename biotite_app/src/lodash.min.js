...
*/
var D="function"==typeof Object.defineProperties?Object.defineProperty:function(x,u,n){x!=Array.prototype&&x!=Object.prototype&&(x[u]=n.value)},E="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;function F(x){if(x){for(var u=E,n=["Math","sign"],w=0;w<n.length-1;w++){var a=n[w];a in u||(u[a]={});u=u[a]}n=n[n.length-1];w=u[n];x=x(w);x!=w&&null!=x&&D(u,n,{configurable:!0,writable:!0,value:x})}}
F(function(x){return x?x:function(u){u=Number(u);return 0===u||isNaN(u)?u:0<u?1:-1}});
(function(){var x,u,n;(function(w){function a(a,c){var t,b;c=c&&c.split("/");var d=r.map,f=d&&d["*"]||{};if(a){a=a.split("/");var k=a.length-1;r.cb&&e.test(a[k])&&(a[k]=a[k].replace(e,""));"."===a[0].charAt(0)&&c&&(k=c.slice(0,c.length-1),a=k.concat(a));for(k=0;k<a.length;k++){var l=a[k];"."===l?(a.splice(k,1),--k):".."===l&&0!==k&&(1!==k||".."!==a[2])&&".."!==a[k-1]&&0<k&&(a.splice(k-1,2),k-=2)}a=a.join("/")}if((c||f)&&d){l=a.split("/");for(k=l.length;0<k;--k){var v=l.slice(0,k).join("/");if(c)for(b=
c.length;0<b;--b)if(t=d[c.slice(0,b).join("/")])if(t=t[v]){var h=t;var q=k;break}if(h)break;if(!y&&f&&f[v]){var y=f[v];var g=k}}!h&&y&&(h=y,q=g);h&&(l.splice(0,q,h),a=l.join("/"))}return a}function g(a,c){return function(){var t=v.call(arguments,0);"string"!==typeof t[0]&&1===t.length&&t.push(null);return p.apply(w,t.concat([a,c]))}}function f(c){return function(t){return a(t,c)}}function h(a){return function(c){d[a]=c}}function b(a){if(k.call(c,a)){var t=c[a];delete c[a];q[a]=!0;A.apply(w,t)}if(!k.call(d,
a)&&!k.call(q,a))throw Error("No "+a);return d[a]}function m(a){var c=a?a.indexOf("!"):-1;if(-1<c){var e=a.substring(0,c);a=a.substring(c+1,a.length)}return[e,a]}function l(a){return function(){return r&&r.M&&r.M[a]||{}}}var p,d={},c={},r={},q={},k=Object.prototype.hasOwnProperty,v=[].slice,e=/\.js$/;var y=function(c,e){c=m(c);var k=c[0];e=e[1];c=c[1];if(k){k=a(k,e);var d=b(k)}k?d&&d.normalize?c=d.normalize(c,f(e)):c=a(c,e):(c=a(c,e),c=m(c),k=c[0],c=c[1],k&&(d=b(k)));return{ga:k?k+"!"+c:c,n:c,fb:k,
p:d}};var z={require:function(a){return g(a)},G:function(a){var c=d[a];return"undefined"!==typeof c?c:d[a]={}},Ma:function(a){return{id:a,uri:"",G:d[a],M:l(a)}}};var A=function(a,e,f,l){var v,r=[];var t=typeof f;var p=(l=l||a)?m(l):[];if("undefined"===t||"function"===t){e=!e.length&&f.length?["require","exports","module"]:e;for(v=0;v<e.length;v+=1){var A=y(e[v],p);t=A.ga;if("require"===t)r[v]=z.require(a);else if("exports"===t){r[v]=z.G(a);var B=!0}else if("module"===t)var n=r[v]=z.Ma(a);else if(k.call(d,
t)||k.call(c,t)||k.call(q,t))r[v]=b(t);else if(A.p)A.p.load(A.n,g(l,!0),h(t),{}),r[v]=d[t];else throw Error(a+" missing "+t);}e=f?f.apply(d[a],r):void 0;a&&(n&&n.G!==w&&n.G!==d[a]?d[a]=n.G:e===w&&B||(d[a]=e))}else a&&(d[a]=f)};x=u=p=function(a,c,e,k,d){if("string"===typeof a)return z[a]?z[a](c):b(y(a,c?m(c):[]).ga);if(!a.splice){r=a;r.Ca&&p(r.Ca,r.$a);if(!c)return;c.splice?(a=c,c=e,e=null):a=w}c=c||function(){};"function"===typeof e&&(e=k,k=d);k?A(w,a,c,e):setTimeout(function(){A(w,a,c,e)},4);return p};
p.M=function(a){return p(a)};x.i=d;n=function(a,e,b){if("string"!==typeof a)throw Error("See almond README: incorrect module build, no module name");e.splice||(b=e,e=[]);k.call(d,a)||k.call(c,a)||(c[a]=[a,e,b])};n.i={jQuery:!0}})();n("external/almond",function(){});n("Vars",["require","exports"],function(n,a){Object.defineProperty(a,"__esModule",{value:!0});a.ba=11;a.T=1.5;a.aa=1;a.ra=2E3;a.S=1.2;a.ta=2.5;a.sa=.1;a.ua=.01;a.xa=500;a.wa=750;a.J=.1;a.$=15;a.va=.05;a.qa=/iPad|iPhone|iPod/.test(navigator.userAgent)&&
...
a;this.apply=function(){var a=[],c;for(c in f.a.meshes)if(f.a.meshes.hasOwnProperty(c)){var e=f.a.meshes[c];if(-1===e.name.indexOf("Decimated")){var l=h(e);null!==l&&(l<b||a.push([l,e,void 0===d?1-b/l:d]))}}a.sort(function(a,c){return c[0]-a[0]});for(c in a)if(a.hasOwnProperty(c)){e=a[c][1];for(l=a[c][2];0<e.getLODLevels().length;){var q=e.getLODLevels()[0].mesh;e.removeLODLevel(q);m(q)}e.simplify([{quality:l,distance:.001}],!1,BABYLON.SimplificationType.QUADRATIC,function(){})}return!0};this.getDescription=
...
function(n,a,g,f,h,b,m,l){function p(){v=g.m();b.a.registerBeforeRender(function(){var a=g.m();null===l.Ha(a).pickedMesh?g.pa(v):v=a})}function d(){jQuery("body").keypress(function(a){32===a.charCode&&c()})}function c(){var a=(new Date).getTime();if(!(250>a-e))switch(e=a,console.log("hi"),m.Fa()){case 2:console.log("teleport");r();break;case 4:q();break;case 3:m.s.v()}}function r(a,c){void 0===a&&(a=void 0);void 0===c&&(c=void 0);void 0===c&&(c=function(){});b.f.gazeTrackerMesh.isVisible=!1;var e=
new BABYLON.Animation("animationCameraTeleportation","position",90,BABYLON.Animation.ANIMATIONTYPE_VECTOR3,BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT),k=g.m();void 0===a&&(a=new BABYLON.Vector3(l.h.x,l.h.y+b.L,l.h.z));var d=g.Ga();a=a.subtract(d);k=k.subtract(d);e.setKeys([{frame:0,value:k},{frame:b.ba,value:a}]);var f=b.a.activeCamera;f.animations=[];f.animations.push(e);b.a.beginAnimation(f,0,b.ba,!1,1,function(){b.f.gazeTrackerMesh.isVisible=!0;f.animations=[];c()})}function q(){var a=l.X,c=
g.m(),e=l.h.subtract(c),k=e.length(),d;.1*k<b.aa?d=l.h.subtract(e.normalize().scale(b.aa)):.1*k>b.T?d=l.h.subtract(e.normalize().scale(b.T)):.1*k<b.T&&(d=c.add(e.scale(.9)));d.y=l.h.y;d.y-a.y<.5*b.S+.1&&(d.y=a.y+.5*b.S+.1);b.Qa(l.h.y-a.y);r(d,function(){f.Pa()})}function k(){y=jQuery("#capture-clicks");y.click(function(){console.log("clicked!");c()});b.a.registerBeforeRender(function(){var a=b.a.activeCamera.inputs.attached.deviceOrientation;(a=a?0!==a._alpha||0!==a._beta||0!==a._gamma:!1)&&!z?(z=
!0,y.show()):!a&&z&&(z=!1,y.ab())})}Object.defineProperty(a,"__esModule",{value:!0});a.c=function(){b.b.j=b.a.getMeshByID(b.b.ja);null===b.b.j&&alert("No mesh named "+b.b.ja);b.b.j.checkCollisions=!0;b.b.j.visibility=0;h.Y(b.b.j);m.la({K:c,mesh:b.b.j});b.b.g=3;d();l.c();k();p()};var v,e=0;a.ca=c;var y=void 0,z=!1});n("Navigation/Pickables","require exports ../Cameras/CommonCamera ../Scene/Optimizations ../Vars ./Navigation".split(" "),function(n,a,g,f,h,b){function m(a){void 0===a.K&&(a.K=b.ca);void 0===
...
g.m()});l.push(a.w)}});n("Cameras/VRControllers","require exports ../Navigation/Navigation ../Navigation/Pickables ../Navigation/Points ../Vars ./CommonCamera ./VRCamera".split(" "),function(n,a,g,f,h,b,m,l){function p(a){a.onTriggerStateChangedObservable.add(function(a){a.pressed&&(a=(new Date).getTime(),a-c>b.xa&&(c=a,g.ca()))})}function d(a){a.onPadStateChangedObservable.add(function(a){(v=a.pressed)&&Math.abs(q)<b.J&&Math.abs(k)<b.J&&console.log("Would reset camera view if you didn't get an error below...")});
a.onPadValuesChangedObservable.add(function(a){q=a.y;k=a.x;Math.abs(k)<b.J&&Math.abs(q)<b.J?k=q=0:.5>Math.abs(k)?k=0:(k+=0<k?-.5:.5,k=2*k)});b.a.registerBeforeRender(function(){if(v){if(!h.h.equals(h.H)){var a=m.m(),e=h.h.subtract(a);e.normalize();e=e.scale(q*b.ua*b.a.getAnimationRatio());m.pa(a.subtract(e))}0!==k&&(a=(new Date).getTime(),a-r<b.wa||(r=a,a=b.f.webVRCamera.rotationQuaternion.toEulerAngles(),a.y+=.25*Math.sign(k)*Math.PI,b.f.webVRCamera.rotationQuaternion=BABYLON.Quaternion.FromEulerVector(a)))}})}
Object.defineProperty(a,"__esModule",{value:!0});var c=0,r=0,q=0,k=0,v=!1;a.c=function(){f.La();b.f.webVRCamera.onControllerMeshLoadedObservable.add(function(a){b.b.g=1;console.log("controller loaded");l.Ra();console.log("Isnt there on pickable or something");p(a);d(a)})}});n("Cameras/VRCamera","require exports ../Navigation/Pickables ../Scene/Optimizations ../Vars ./VRControllers".split(" "),function(n,a,g,f,h,b){function m(){h.f.onEnteringVRObservable.add(function(){h.b.g=2;p();g.C(void 0);f.I();
...
[];a=a.split("geometry IndexedFaceSet {").splice(1);for(var d in a)if(a.hasOwnProperty(d)){var e=a[d];k.push({colors:h(m("color [","]",e)),coors:f(m("point [","]",e)),trisIdxs:b(m("coordIndex [","]",e))})}void 0===c&&(c=l(k));d=c;a=k.length;for(e=0;e<a;e++)for(var g=k[e].coors.length,q=0;q<g;q+=3)k[e].coors[q]-=d[0],k[e].coors[q+1]-=d[1],k[e].coors[q+2]-=d[2];if(r){p=[];d=["colors","coors","trisIdxs"];for(var n in k)if(k.hasOwnProperty(n))for(var t in d)if(d.hasOwnProperty(t)){a=d[t];e=k[n][a];g=
[];q=0;for(var w=e.length;q<w;)g.push(e.slice(q,q+=1E7));e=g;for(var u in e)e.hasOwnProperty(u)&&p.push([+n,a,e[u]])}return[]}return k}function f(a){a=a.match(d);for(var b=a.length,c=new Float32Array(b),e=0;e<b;e+=3)c[e]=+a[e+2],c[e+1]=+a[e+1],c[e+2]=+a[e];return c}function h(a){a=a.match(d);for(var b=new Float32Array(4*a.length/3),c=b.length,e=0;e<c;e+=4){var f=3*e/4;b[e]=+a[f];b[e+1]=+a[f+1];b[e+2]=+a[f+2];b[e+3]=1}return b}function b(a){a=a.match(d);for(var b=3*a.length/4,c=new Uint32Array(b),
e=0;e<b;e+=3){var f=4*e/3;c[e]=+a[f];c[e+1]=+a[f+1];c[e+2]=+a[f+2]}return c}function m(a,b,c){a=c.split(a,2);if(1>=a.length)return"";a=a[1].split(b,2);return a[0]}function l(a){if(0===a.length)return new Float32Array([0,0,0]);var b=a.map(function(a){return a.coors.length}).reduce(function(a,b){return a+b});if(0===b)return new Float32Array([0,0,0]);for(var c=0,e=0,d=0,f=a.length,h=0;h<f;h++)for(var g=a[h].coors,l=g.length,m=0;m<l;m+=3)c+=g[m],e+=g[m+1],d+=g[m+2];a=b/3;return new Float32Array([c/a,
e/a,d/a])}Object.defineProperty(a,"__esModule",{value:!0});var p=void 0,d=/(^|-| )[0-9.]{1,8}/g,c=void 0,r=!1;"undefined"!==typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope&&(r=!0);r&&(self.onmessage=function(a){var b=a.data.cmd;a=a.data.data;"start"===b&&(g(a),b="sendDataChunk");"sendDataChunk"===b&&(b=p.shift(),postMessage({chunk:b,status:0===p.length?"done":"more"}))});a.Ja=g});n("Mols/3DMol/VRML","require exports ../../Scene/Optimizations ../../Vars ../CommonLoader ./VRMLParserWebWorker".split(" "),
function(n,a,g,f,h,b){function m(a){d=[];"undefined"!==typeof Worker?("undefined"===typeof k&&(k=new Worker("VRMLParserWebWorker.js")),k.onmessage=function(b){b=b.data;var c=b.chunk;b=b.status;var e=c[0],f=c[1],h=c[2];d.length===e&&d.push({coors:new Float32Array(0),colors:new Float32Array(0),trisIdxs:new Uint32Array(0)});c=d[e];e=[d[e][f],h];for(var g=0,l=0;l<e.length;l++)h=e[l],g+=h.length;g=new ("trisIdxs"===f?Uint32Array:Float32Array)(g);for(var m=l=0;m<e.length;m++)h=e[m],g.set(h,l),l+=h.length;
c[f]=g;switch(b){case "more":k.postMessage({cmd:"sendDataChunk",data:void 0});break;case "done":a();break;default:console.log("Error here!")}},k.postMessage({cmd:"start",data:q})):(d=b.Ja(q),a())}function l(){var a=[],b;for(b in d)if(d.hasOwnProperty(b)){var c=d[b],k=[];BABYLON.VertexData.ComputeNormals(c.coors,c.trisIdxs,k);var g=new BABYLON.VertexData;g.positions=c.coors;g.indices=c.trisIdxs;g.normals=k;g.colors=c.colors;c=new BABYLON.Mesh("mesh_3dmol_tmp"+b,f.a);g.applyToMesh(c);g=new BABYLON.StandardMaterial("Material",
f.a);g.diffuseColor=new BABYLON.Color3(1,1,1);g.emissiveColor=new BABYLON.Color3(0,0,0);g.specularColor=new BABYLON.Color3(0,0,0);c.material=g;a.push(c)}if(0<a.length){var l=BABYLON.Mesh.MergeMeshes(a,!0,!0);l.name="MeshFrom3DMol"+Math.random().toString();l.id=l.name;h.Sa(l)}return l}function p(a,b){if(void 0!==a){a.scaling=new BABYLON.Vector3(1,1,1);a.position=new BABYLON.Vector3(0,0,0);f.a.render();if(void 0===c){var e=b.getBoundingInfo().boundingBox;b=Object.keys(e.maximumWorld).map(function(a){return e.maximumWorld[a]-
e.minimumWorld[a]});var d=a.getBoundingInfo().boundingBox,k=Object.keys(d.maximumWorld).map(function(a){return d.maximumWorld[a]-d.minimumWorld[a]});b=b.map(function(a,b){return a/k[b]});b=Math.min.apply(null,b);c=new BABYLON.Vector3(b,b,b);a.scaling=c;f.a.render();r=d.centerWorld.subtract(e.centerWorld)}else a.scaling=c;a.position=a.position.subtract(r);g.I()}}Object.defineProperty(a,"__esModule",{value:!0});var d=[],c,r,q,k;a.c=function(){jQuery("body").append('<div\n        id="mol-container"\n        class="mol-container"\n        style="display:none;"></div>');
var b=jQuery("#mol-container");a.u=$3Dmol.createViewer(b,{backgroundColor:"white"});window.viewer=a.u};a.Ia=function(b){jQuery.ajax("https://files.rcsb.org/view/1XDN.pdb",{success:function(c){a.u.addModel(c,"pdb");b()},error:function(a,b,c){console.error("Failed to load PDB https://files.rcsb.org/view/1XDN.pdb: "+c)}})};a.render=function(b,c){void 0===b&&(b=!0);void 0===c&&(c=function(){});f.l.hideLoadingUI();a.u.render();b&&(q=a.u.exportVRML(),m(function(){var a=l();p(a,f.a.getMeshByName("protein_box"));
c(a);d=[]}))};a.bb=l;a.eb=p});n("Mols/3DMol/Visualize",["require","exports","../../Scene/Optimizations","./VRML"],function(n,a,g,f){function h(a,b){f.render(!0,function(c){for(var d in l)if(l.hasOwnProperty(d)){var f=l[d];f.B===a.B&&(g.Oa(f.mesh),delete l[d],console.log("deleting old mesh..."))}"Surface"===b&&(c.material.backFaceCulling=!1);l[a.V]={B:a.B,mesh:c};console.log("added new mesh");console.log(l)})}function b(a,b,d){a.sort();return{B:a.join("-")+"-"+b,V:a.join("-")+"-"+b+"-"+d}}function m(a){var b=
a.map(function(a){return a}),c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b.push(d.toUpperCase());b.push(d.toLowerCase())}return b=b.filter(function(a,c){return b.indexOf(a)>=c})}Object.defineProperty(a,"__esModule",{value:!0});var l={},p={All:{},Protein:{resn:m("ALA ARG ASP ASN ASX CYS GLN GLU GLX GLY HIS HSP HYP ILE LEU LYS MET PCA PHE PRO TRP TYR VAL GLU SER THR MSE".split(" "))},Acidic:{resn:m(["ASP","GLU"])},Cyclic:{resn:m(["HIS","PHE","PRO","TRP","TYR"])},Aliphatic:{resn:m(["ALA","GLY","ILE",
"LEU","VAL"])},Aromatic:{resn:m(["HIS","PHE","TRP","TYR"])},Basic:{resn:m(["ARG","HIS","LYS","HSP"])},Charged:{resn:m("ASP GLU ARG HIS LYS HSP".split(" "))},Hydrophobic:{resn:m("ALA LEU VAL ILE PRO PHE MET TRP".split(" "))},Neutral:{resn:m("VAL PHE GLN TYR HIS CYS MET TRP ASX GLX PCA HYP".split(" "))},Nucleic:{resn:m("ADE A GUA G CYT C THY T URA U".split(" "))},Purine:{resn:m(["ADE","A","GUA","G"])},Pyrimidine:{resn:m("CYT C THY T URA U".split(" "))},Ions:{resn:m("AL BA CA CAL CD CES CLA CL CO CS CU CU1 CUA HG IN IOD K MG MN3 MO3 MO4 MO5 MO6 NA NAW OC7 PB POT PT RB SOD TB TL WO4 YB ZN ZN1 ZN2".split(" "))},
Water:{resn:m(["WAT","HOH","TIP","TIP3"])}};p.Ligand={not:{or:[p.Protein,p.Nucleic,p.Ions,p.Water]}};var d={Element:{colorscheme:"default"},Red:{color:"red"},Blue:{color:"blue"},Green:{color:"green"},Orange:{color:"orange"},Yellow:{color:"yellow"},Purple:{color:"purple"},Spectrum:{color:"spectrum"}};a.Ya=function(a,g,m){var c=b(a,g,m);if("Hide"===m)for(var n in l)l.hasOwnProperty(n)&&(a=l[n],a.B===c.B&&(a.mesh.isVisible=!1,console.log("Hiding existing mesh...")));else void 0!==l[c.V]?(l[c.V].mesh.isVisible=
!0,console.log("showing existing mesh...")):(f.u.setStyle({}),n=d[m],a={and:a.map(function(a){return p[a]})},"surface"===g.toLowerCase()?f.u.addSurface($3Dmol.SurfaceType.MS,n,a,void 0,void 0,function(){h(c,g)}):(m={},m[g.toLowerCase()]=n,f.u.addStyle(a,m),h(c,g)))}});n("UI/Menu3D","require exports ../Cameras/CommonCamera ../Mols/3DMol/Visualize ../Navigation/Pickables ../Navigation/Points ../Vars".split(" "),function(n,a,g,f,h,b,m){function l(){function a(a){if(b.hasOwnProperty(a)){e[a]=new BABYLON.GUI.SpherePanel;
v.addControl(e[a]);e[a].blockLayout=!0;b[a].reverse();var c=function(c){if(b[a].hasOwnProperty(c)){c=b[a][c];var d=c.D,f=c.P;k.push(new C({v:function(){f()},default:!1,O:d,ka:function(a){a.isVisible(!1)},level:+a,name:"menu-visible-button-"+d,oa:e[a],R:d,color:c.color}));e[a].columns=4;window.panels=e;e[a].blockLayout=!1;e[a].linkToTransformNode(w);setInterval(function(){e[a].radius=m.ta;e[a].margin=m.sa},1E3)}},d;for(d in b[a])c(d)}}var b=p();b=d(b);w=new BABYLON.TransformNode("");v=new BABYLON.GUI.GUI3DManager(m.a);
for(var c in b)a(c)}function p(){function a(e,f,g){function h(d){if(k.hasOwnProperty(d)){d=k[d];var h=e[d];c[f]=void 0===c[f]?[]:c[f];switch(typeof h){case "function":c[f].push({P:h,D:d,F:g});break;case "object":var l=b(f+1);c[f].push({color:t,P:function(){r(l)},D:d+" \u21e8",F:g});a(h,l,f);break;default:alert("error!")}}}d.push(f);var k=Object.keys(e),l;for(l in k)h(l)}function b(a){for(;-1!==d.indexOf(a);)a++;return a}var c={},d=[];a(q,1,void 0);return c}function d(a){function b(b){if(a.hasOwnProperty(b)){a[b].sort(function(a,
b){return(""+a.D).localeCompare(b.D)});var c=+b;1<c&&a[b].push({color:B,P:function(){r(a[b][0].F)},D:"Back \u21e6",F:a[b][0].F});0<c&&a[b].push({color:G,P:function(){x.Z()},D:"Close Menu \u00d7",F:a[b][0].F})}}for(var c in a)b(c);console.log(a);return a}function c(){var a=new BABYLON.GUI.StackPanel3D;v.addControl(a);x=new C({v:function(a){a.value?r(1):r(0);w.position.copyFrom(g.m());w.rotation.y=g.ia()},default:!1,O:"Show Menu",level:0,name:"menu-visible-button",oa:a,R:"Hide Menu"});var c=new BABYLON.TransformNode("");
a.linkToTransformNode(c);c.rotation.x=.5*Math.PI;m.a.registerBeforeRender(function(){c.position.copyFrom(b.W);c.position.y+=.1;c.rotation.y=g.ia()})}function r(a){for(var b in k)if(k.hasOwnProperty(b)){var c=k[b];0===c.level?c.isVisible(!0):c.level===a?c.isVisible(!0):c.isVisible(!1)}}Object.defineProperty(a,"__esModule",{value:!0});var q=function(){function a(a){if(b.hasOwnProperty(a)){var d=b[a];h[d]={};a=function(a){if(c[d].hasOwnProperty(a)){var b=c[d][a];h[d][b]={};a=function(a){if(e[d].hasOwnProperty(a)){var c=
e[d][a];h[d][b][c]={};a=function(a){if(g.hasOwnProperty(a)){var e=g[a];h[d][b][c][e]=function(){f.Ya([d,b],c,e);x.Z()}}};for(var k in g)a(k)}};for(var k in e[d])a(k)}};for(var k in c[d])a(k)}}var b=["Protein","Ligand","Water","Nucleic"],c={Ligand:["All"],Nucleic:["All"],Protein:["All","Hydrophobic","Hydrophilic","Charged","Aromatic"],Water:["All"]},d=["Stick","Sphere","Surface"],e={Ligand:d,Nucleic:d,Protein:["Cartoon"].concat(d),Water:d},g="Element Red Blue Green Orange Yellow Purple Spectrum Hide".split(" "),
h={},k;for(k in b)a(k);return h}(),k=[],v,e={},w,u,x,t=new BABYLON.Color3(.3,.35+.1,.4),B=new BABYLON.Color3(.4,.35+.1,.4),G=new BABYLON.Color3(.4,.35,.4);a.c=function(a){l(a);c();u=new BABYLON.Sound("click-button","assets/staple-public-domain.mp3",m.a,null,{loop:!1,autoplay:!1,ib:!0,volume:.1})};var C=function(){function a(a){var b=this;this.button=new BABYLON.GUI.HolographicButton(a.name);a.oa.addControl(this.button);if(void 0!==a.color){var c=this.button.mesh.material.clone();c.albedoColor=a.color;
this.button.mesh.material=c}this.level=a.level;this.A=new BABYLON.GUI.TextBlock;this.A.color="white";this.A.i=!0;this.value=a.default;this.R=a.R;this.O=a.O;this.v=a.v;this.ea();this.i=BABYLON.Mesh.CreateSphere(a.name+"-container-mesh",2,m.S,m.a);this.i.position=this.button.node.absolutePosition;this.i.visibility=0;this.i.v=function(){b.Z()};h.ya(this.i);void 0!==a.ka&&a.ka(this)}a.prototype.isVisible=function(a){if(void 0===a)return this.button.isVisible;this.button.isVisible=a;this.i.isVisible=a};
a.prototype.Z=function(){u.setPosition(this.i.position.clone());u.play();this.value=!this.value;this.v(this);this.ea()};a.prototype.ea=function(){this.A.text=this.value?this.R:this.O;this.button.content.dispose();this.button.content=this.A};return a}()});n("Mols/3DMol/ThreeDMol",["require","exports","../CommonLoader","./VRML"],function(n,a,g,f){function h(a){f.c();f.Ia(function(){f.u.setStyle({},{cartoon:{color:"spectrum"}});f.render();g.Aa(a)})}Object.defineProperty(a,"__esModule",{value:!0});a.c=
function(a){try{jQuery.getScript("https://3Dmol.csb.pitt.edu/build/3Dmol-min.js",function(){h(a)})}catch(m){h(a)}}});n("Mols/Load","require exports ../Scene/Optimizations ../UI/Menu3D ../Vars ./3DMol/ThreeDMol ./CommonLoader".split(" "),function(n,a,g,f,h,b,m){Object.defineProperty(a,"__esModule",{value:!0});a.c=function(){m.Ba();jQuery.getJSON("scene_info.json",function(a){!1===a.menuActive&&(h.b.ma=!1);b.c(a);h.b.ma&&f.c(a);g.I()})}});n("UI/LoadingScreens",["require","exports","../Vars"],function(n,
a,g){function f(){clearInterval(h)}Object.defineProperty(a,"__esModule",{value:!0});var h;a.Na=function(){document.getElementById("loading-container").outerHTML=""};a.da=function(a){f();g.l.displayLoadingUI();g.l.loadingUIText=a};a.Wa=function(){var a=90;clearInterval(h);h=setInterval(function(){a+=.02*(99-a);g.l.displayLoadingUI();g.l.loadingUIText="Loading the main scene... "+a.toFixed(0)+"%"},100)};a.Xa=f});n("UI/UI2D",["require","exports","../Vars"],function(n,a,g){function f(){jQuery("body").append('\n        <button\n          title="Click to switch to full screen"\n          id="fullscreen-button"\n          class="ui-button"\n          style="color:white;\n                 width:80px;\n                 right:20px;\n                 position:absolute;\n                 height:50px;\n                 bottom:80px;\n                 background-color:rgba(51,51,51,0.7);\n                 border:none;\n                 outline:none;\n                 cursor:pointer;">\n            <svg\n              style="position:relative; left:0.5px;"\n              width="48" height="48"\n              xmlns="http://www.w3.org/2000/svg"\n              xmlns:svg="http://www.w3.org/2000/svg"\n              clip-rule="evenodd">\n                <g class="layer">\n                    <path d="m47.799999,43.649999l-47.699999,0l0,-39.749999l47.699999,0l0,39.749999zm-1.9875,-37.762499l-43.724999,0l0,35.774999l43.724999,0l0,-35.774999zm-7.95,13.9125l-1.9875,0l0,-6.441487l-22.341487,22.341487l6.441487,0l0,1.9875l-9.9375,0l0,-9.9375l1.9875,0l0,6.441487l22.341487,-22.341487l-6.441487,0l0,-1.9875l9.9375,0l0,9.9375z" fill="#ffffff" id="svg_1"/>\n                </g>\n            </svg>\n        </button>\n\n        <button\n          title="Click for help"\n          id="help-button"\n          class="ui-button"\n          style="color:white;\n                 width:80px;\n                 right:20px;\n                 position:absolute;\n                 height:50px;\n                 bottom:140px;\n                 background-color:rgba(51,51,51,0.7);\n                 border:none;\n                 outline:none;\n                 cursor:pointer;">\n                 <svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"\n\t x="0px" y="0px" width="48px" height="48px" viewBox="0 0 48 48" xml:space="preserve">\n<path fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="\n\tM35.5,9.8c1.7,5.4-0.6,8-1.6,8.9c-1.9,1.9-4.5,4.7-5.8,7c-1.5,2.7-4.1,12-6.8,4.4c-3.2-9.1,1.3-11.6,3.5-13.4\n\tc1.5-1.3,3.4-4.3,0.5-5.3c-4-1.3-6.1,5.3-10.7,4c-3-0.8-3.2-4.1-2.2-6.6C15.4,1.7,32.5,0.6,35.5,9.8L35.5,9.8z"/>\n<path fill="none" stroke="#FFFFFF" stroke-width="2" stroke-miterlimit="10" d="M28.3,39.6c0-5.5-8.5-5.5-8.5,0S28.3,45.1,28.3,39.6\n\t"/>\n</svg>\n\n        </button>\n    ');
...
"15";document.getElementById("scene-explorer-host").style.zIndex="15"},500)}});n("Scene/LoadAndSetup","require exports ../Cameras/Setup ../Cameras/VRCamera ../Mols/Load ../Navigation/Navigation ../Navigation/Pickables ../UI/LoadingScreens ../UI/UI2D ../Vars ./Optimizations".split(" "),function(n,a,g,f,h,b,m,l,p,d,c){function r(){var a=BABYLON.Mesh.CreateSphere("navTargetMesh",4,.1,d.a),b=new BABYLON.StandardMaterial("myMaterial",d.a);b.diffuseColor=new BABYLON.Color3(1,0,1);a.material=b;d.Va({ja:"ground",
na:a});f.c();c.c();window.i=d}function q(a){l.da("Loading the main scene...");BABYLON.SceneLoader.LoadAssetContainer("scene/","scene.babylon",d.a,function(b){l.Wa();d.a.executeWhenReady(function(){b.addAllToScene();d.a.activeCamera=d.a.cameras[0];for(var e=!1,f=0;1<d.a.lights.length;){var g=d.a.lights[f].name.toLowerCase();-1===g.indexOf("shadowlight")&&-1===g.indexOf("shadow_light")?d.a.lights[f].dispose():e?d.a.lights[f].dispose():(e=!0,f++)}for(var h in d.a.meshes)"protein_box"===d.a.meshes[h].name&&
(d.a.getMeshByName("protein_box").isVisible=!1);for(var k in d.a.meshes)if(d.a.meshes[k].material){e=d.a.meshes[k];if(void 0===e.material.emissiveTexture||null===e.material.emissiveTexture)e.material.emissiveTexture=e.material.diffuseTexture,e.material.diffuseColor=new BABYLON.Color3(0,0,0),e.material.specularColor=new BABYLON.Color3(0,0,0),e.material.emissiveColor=new BABYLON.Color3(0,0,0);c.ha(e,!1);m.la({mesh:e,a:d.a})}a()})},function(a){a.lengthComputable&&l.da("ALoading the main scene... "+Math.round(90*
a.loaded/a.total).toString()+"%")})}Object.defineProperty(a,"__esModule",{value:!0});a.load=function(){d.c();l.Na();r();q(function(){g.c();b.c();m.c();p.c();h.c()});window.addEventListener("resize",function(){d.l.resize()})};a.Ka=function(){setTimeout(c.I,1E3);l.Xa();d.a.activeCamera.maxZ=250;d.a.activeCamera.minZ=0;d.l.runRenderLoop(function(){d.a.render()})}});u.M({urlArgs:"bust="+(new Date).getTime()});u(["Scene/LoadAndSetup"],function(n){n.load()});n("Start",function(){})})();
