...
define('Scene/Optimizations',["require", "exports", "../Mols/Shadows", "../Vars"], function (require, exports, Shadows, Vars) {
    ...
    function SimplifyMeshes(priority, minNumVertsThatIsProblem, decimationLevel) {
        ...
        this["apply"] = function (scene) {
            ...
            for (var meshIdx in meshesToConsider) {
                if (meshesToConsider.hasOwnProperty(meshIdx)) {
                    var mesh = meshesToConsider[meshIdx][1];
                    var decimationLvel = meshesToConsider[meshIdx][2];
    ...
    var ButtonWrapper = /** @class */ (function () {
        ...
        function ButtonWrapper(params) {
            ...
            if (params.color !== undefined) {
                ...
                var newMat = this.button.mesh.material.clone();
         ...
         * @returns void
         */
        ButtonWrapper.prototype.updateTxt = function () {
...
define('Mols/3DMol/Visualize',["require", "exports", "../../Scene/Optimizations", "../../Vars", "./VRML"], function (require, exports, Optimizations, Vars, VRML) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function toggleRep(filters, repName, colorScheme) {
        ...
        var sels = { "and": filters.map(function (i) { return selKeyWordTo3DMolSel[i]; }) };
     ...
     * @returns void
     */
    function toggleRepContinued(keys, repName) {
...
define('Mols/3DMol/VRMLParserWebWorker',["require", "exports"], function (require, exports) {
    ...
    function loadValsFromVRML(vrmlStr, removeExtraPts) {
        ...
        for (var idx in vrmlChunks) {
            if (vrmlChunks.hasOwnProperty(idx)) {
                var vrmlChunk = vrmlChunks[idx];
...
define('Mols/3DMol/VRML',["require", "exports", "../../Scene/Optimizations", "../../Vars", "../CommonLoader", "./Visualize", "./VRMLParserWebWorker"], function (require, exports, Optimizations, Vars, CommonLoader, Visualize, VRMLParserWebWorker) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var modelData = [];
    ...
    function resetAll() {
        if (hasActiveSurface) {
            ...
            exports.viewer = null;
            setup(function () {
                exports.viewer.addModel(pdbTxt, "pdb");
            });
        }
    ...
    function loadPDBURL(url, callBack) {
        jQuery.ajax(url, {
            "success": function (data) {
                ...
                var mdl = exports.viewer.addModel(data, "pdb");
                // viewer.zoomTo();
     ...
     * @returns void
     */
    function setMolRotation(axis, amount) {
    ...
    function positionAll3DMolMeshInsideAnother(babylonMesh, otherBabylonMesh) {
        ...
        var thisBox;
        var thisBoxDimens;
        var _loop_1 = function (allVisMolMeshIdx) {
            if (allVisMolMeshes.hasOwnProperty(allVisMolMeshIdx)) {
                var allVisMolMesh = allVisMolMeshes[allVisMolMeshIdx];
                // Get the bounding box of this mesh.
                var thisBoxTmp_1 = allVisMolMesh.getBoundingInfo().boundingBox;
                var thisBoxDimensTmp = Object.keys(thisBoxTmp_1.maximumWorld).map(function (k) { return thisBoxTmp_1.maximumWorld[k] - thisBoxTmp_1.minimumWorld[k]; });
                var volume = thisBoxDimensTmp[0] * thisBoxDimensTmp[1] * thisBoxDimensTmp[2];
                if (volume > maxVol) {
                    maxVol = volume;
                    thisBox = thisBoxTmp_1;
                    thisBoxDimens = thisBoxDimensTmp;
                }
            }
        };
        for (var allVisMolMeshIdx in allVisMolMeshes) {
            _loop_1(allVisMolMeshIdx);
        }
        // Get the scales
...
define('UI/Menu3D/Rotations',["require", "exports", "../../Mols/3DMol/VRML", "../../Vars"], function (require, exports, VRML, Vars) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function buildRotationsSubMenu() {
        var amt = 30.0 * Math.PI / 180.0;
        return {
            "X Axis": function () {
                VRML.setMolRotation("x", amt);
                VRML.positionAll3DMolMeshInsideAnother(undefined, Vars.scene.getMeshByName("protein_box"));
            },
            "Y Axis": function () {
                VRML.setMolRotation("y", amt);
                VRML.positionAll3DMolMeshInsideAnother(undefined, Vars.scene.getMeshByName("protein_box"));
            },
            "Z Axis": function () {
                VRML.setMolRotation("z", amt);
                VRML.positionAll3DMolMeshInsideAnother(undefined, Vars.scene.getMeshByName("protein_box"));
            },
        };
    }
...
define('UI/Menu3D/Styles',["require", "exports", "../../Mols/3DMol/Visualize", "./Menu3D"], function (require, exports, Visualize, Menu3D) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var colorSchemes = [
        "Element", "Amino Acid", "Chain", "Nucleic", "White", "Red", "Blue",
        "Green", "Orange", "Yellow", "Purple", "Spectrum", "Hide",
    ];
    function buildStylesSubMenu() {
        ...
        for (var _i = 0, components_1 = components; _i < components_1.length; _i++) {
            ...
            menu[component] = {};
            for (var _a = 0, _b = selections[component]; _a < _b.length; _a++) {
                var selection = _b[_a];
                menu = makeRepColorSchemeSubMenus(menu, component, selection);
            }
        }
        ...
        //         if (sels.length < 20) {
        //             menu[component] = {};
        //             // Not so many, so just show them all.
        ...
        //     }
        // }
        alert("Need to make functions on customselections reight. Also ranges.");
        console.log(menu);
        return menu;
    }
    exports.buildStylesSubMenu = buildStylesSubMenu;
    function makeRepColorSchemeSubMenus(menu, component, selection) {
        ...
        var _loop_1 = function (rep) {
            ...
            var _loop_2 = function (colorScheme) {
                menu[component][selection][rep][colorScheme] = function () {
...
define('UI/Menu3D/Menu3D',["require", "exports", "../../Cameras/CommonCamera", "../../Navigation/Points", "../../Vars", "./Button", "./Rotations", "./Styles"], function (require, exports, CommonCamera, VRPoints, Vars, Button, Rotations, Styles) {
    ...
    var sceneInfoData;
    // These can be initialized here.
    var colorDelta = 0.1;
    // const defaultButtonColor = new BABYLON.Color3(0.3, 0.35, 0.4);
    var greenColor = new BABYLON.Color3(0.3, 0.35 + colorDelta, 0.4);
    var yellowColor = new BABYLON.Color3(0.3 + colorDelta, 0.35 + colorDelta, 0.4);
    var redColor = new BABYLON.Color3(0.3 + colorDelta, 0.35, 0.4);
    /**
    ...
    function removeMenuButtons() {
        // Remove the clickable spheres around the buttons.
        Vars.scene.meshes.filter(function (m) {
            var removeIt = m.name.slice(0, 20) === "menu-visible-button-";
            if (removeIt) {
                m.dispose();
                m = null;
            }
        ...
        if (GUI3DMenuManager !== undefined) {
            GUI3DMenuManager.utilityLayer.utilityLayerScene.meshes.filter(function (m) {
                m.dispose();
                m = null;
                return false;
            });
        }
        // Erase all the panels.
        for (var panelIdx in panels) {
            if (panels.hasOwnProperty(panelIdx)) {
                var panel = panels[panelIdx];
                for (var i in panel["children"]) {
                    if (panel["children"].hasOwnProperty(i)) {
                        var m = panel["children"][i];
                        m.dispose();
                        m = null;
                    }
                }
                panel.dispose();
                panel = null;
                delete panels[panelIdx];
            }
        }
        // Destroy the GUI manager too.
        GUI3DMenuManager = null;
    }
    ;
    /**
     * Setup the main menu.
    ...
    function setupMainMenu() {
        ...
        // If you make the buttons here, they are spaced correctly.
        // for (let level in menuInfFlat) {
        //     if (menuInfFlat.hasOwnProperty(level)) {
        //         createPanelIfNeeded(+level);
        //     }
        // }
    ...
    function createPanelIfNeeded(level) {
        if (panels[level] !== undefined) {
            // It's been created previously.
            return;
        }
        // To get things to render in a better order, you need to reverse them.
        // Very strange.
        menuInfFlat[level].reverse();
        ...
        var _loop_1 = function (idx) {
            if (menuInfFlat[level].hasOwnProperty(idx)) {
                var btnInf = menuInfFlat[level][idx];
                var txt = btnInf.txt;
                var func_1 = btnInf.func;
                var color = btnInf.color;
                var levelInt = +level;
        ...
        // Add buttons
        for (var idx in menuInfFlat[level]) {
            _loop_1(idx);
        }
        // Set radius and such.
    ...
    var showOnlyButtonsOfLevel = function (level) {
        if (level > 1) { // Not the main menu.
            latestLevelViewed = level;
        }
        console.log("Latest", latestLevelViewed);
        if (level > 0) {
            // Also check if the panel needs to be created.
            createPanelIfNeeded(level);
        }
        for (var idx in allButtons) {
            if (allButtons.hasOwnProperty(idx)) {
                var btn = allButtons[idx];
                if (btn.level === 0) {
    ...
    window["showOnlyButtonsOfLevel"] = showOnlyButtonsOfLevel;
});
...
define('Mols/3DMol/ThreeDMol',["require", "exports", "../../UI/Menu3D/Menu3D", "../CommonLoader", "./Visualize", "./VRML"], function (require, exports, Menu3D, CommonLoader, Visualize, VRML) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.atomicInfo = {};
    /**
    ...
    function after3DMolJsLoaded(sceneInfoData) {
        VRML.setup(function () {
            var pdbUri = "https://files.rcsb.org/view/1XDN.pdb";
            VRML.loadPDBURL(pdbUri, function (mdl3DMol) {
...
define('UI/UI2D',["require", "exports", "../Vars"], function (require, exports, Vars) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
