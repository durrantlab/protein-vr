define(["require", "exports", "./Objects/CollisionMeshes", "./Core/MouseState", "./Settings/UserVars", "./Events/Event", "./Events/Actions/MoveCamera", "./Events/Actions/RotateCamera", "./Events/TriggerConditionals/AlwaysTrue", "./Events/TriggerConditionals/ClickedObject"], function (require, exports, CollisionMeshes_1, MouseState, UserVars, Event_1, MoveCamera_1, RotateCamera_1, AlwaysTrue_1, ClickedObject_1) {
    "use strict";
    ...
    */
    ...
    exports.broadcastCheckFrequency = 5000;
    function setup() {
        /**
    ...
    function goToLocation(VRCamera) {
        if (VRCamera === void 0) { VRCamera = false; }
        jQuery = PVRGlobals.jQuery;
        var url = window.location.href;
        // console.log("Current url is: " + url);
        // let pattern = "?id=";
        ...
        jQuery.ajax({
            ...
            var newPos = new BABYLON.Vector3(Number(obj.locx), Number(obj.locy), Number(obj.locz));
            new Event_1.default(new AlwaysTrue_1.default({}), new MoveCamera_1.default({
                milliseconds: exports.broadcastCheckFrequency,
                endPoint: newPos
            }));
            // setPosition(newPos);
            if (!VRCamera) {
                var newRot = new BABYLON.Vector3(Number(obj.rotx), Number(obj.roty), Number(obj.rotz));
                new Event_1.default(new AlwaysTrue_1.default({}), new RotateCamera_1.default({
                    milliseconds: exports.broadcastCheckFrequency,
                    endRotation: newRot
                }));
            }
