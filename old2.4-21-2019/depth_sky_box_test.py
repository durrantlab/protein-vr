...
uniq_id = "tmp_sphere_mirror109"
uv_sphere_subdivisions = 6 # 6 is good one for inital high res.
...
objects_with_mesh_data, new_sphere, sphere_center_world = first_make_environ_mesh()
texture = second_setup_combined_bake_material(uniq_id)
third_bake_environ_texture(new_sphere)
# forth_add_shadeless_material(uniq_id, new_sphere, texture)
forth_add_emit_material(uniq_id, new_sphere, texture)
...
nrml_texture = seventh_setup_normal_bake_material(uniq_id + "_nrml", low_res_new_sphere)
