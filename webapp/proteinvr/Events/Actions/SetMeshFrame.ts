...
class SetMeshFrame extends parent {
    ...
    public do() {
        ...
        */
        ...
        PVRGlobals.scene.beginAnimation(this.parameters["mesh"], this.parameters["frame"], this.parameters["frame"], false, 1.0)
    }
}

export default SetMeshFrame;