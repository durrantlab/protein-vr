...
define(["require", "exports", "./proteinvr/Events/Event", "./proteinvr/Events/TriggerConditionals/DistanceToMesh", "./proteinvr/Events/Actions/MoveCamera", "./proteinvr/Events/Actions/AdministerQuiz", "./proteinvr/Events/TriggerConditionals/KeyPress", "./proteinvr/Events/TriggerConditionals/ClickedObject", "./proteinvr/Events/Actions/LabelOnMesh", "./proteinvr/CameraChar"], function (require, exports, Event_1, DistanceToMesh_1, MoveCamera_1, AdministerQuiz_1, KeyPress_1, ClickedObject_1, LabelOnMesh_1, CameraChar_1) {
    "use strict";
        ...
        var setEvents = function () {
            ...
            */
            ...
            new Event_1.default(new DistanceToMesh_1.default({
                triggerMesh: Core.meshesByName["surf_trgt"],
                cutOffDistance: 9.0
            }), new MoveCamera_1.default({
                camera: CameraChar_1.default.camera,
                milliseconds: 1000,
                startPoint: CameraChar_1.default.camera.position,
                endPoint: new BABYLON.Vector3(CameraChar_1.default.camera.position.x + 25, CameraChar_1.default.camera.position.y, CameraChar_1.default.camera.position.z)
            }));
            // new Event(
            // new GameStart({}, jQuery),
            // new MoveCamera({
