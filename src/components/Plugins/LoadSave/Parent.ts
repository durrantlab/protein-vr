...
export class LoadSaveParent {
    ...
    //  * @param  {boolean=}  hidden  Whether to initially hide the checkbox. False by default.
    //  */
    // public _checkBox(id: string, label: string, helpMsg: string, hidden: boolean = false) {
    //     return `
    //         <div class="row ${id}-container"${hidden ? ' style="display:none;"' : ''}">
    //             <div class="col-md-12">
    ...
    public _onUserInterfaceDone(): void {
        ...
        // plugin).
        console.log("NEED TO FIX FILE THING HERE");
