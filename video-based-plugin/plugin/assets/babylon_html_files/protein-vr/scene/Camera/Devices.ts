...
function _setupVRDeviceOrientationFreeCamera(): void {
    /*
...
export function _setupWebVRFreeCamera(): void {
    /*
...
function _makeCameraReplaceActiveCamera(camera: any): void {
    /*
...
function _setupMouseAndKeyboard(): void {
    /*
...
function _setupMouseClick(): void {
    /*
