...
export class Sphere {
    ...
    */
    ...
    private _sphereMesh: any = null;  // BABYLON.Mesh
    ...
    public opacity(val: number = undefined): void {
        ...
        */
        ...
        } else if ((this._sphereMesh !== undefined) && (this._sphereMesh !== null)) {  // If this._sphereMesh is undefined, probably hasn't been loaded yet.
            // Setter
