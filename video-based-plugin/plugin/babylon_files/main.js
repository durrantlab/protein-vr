if (BABYLON.Engine.isSupported()) {
    ...
    BABYLON.SceneLoader.Load("scene/", "babylon.babylon", engine, function (scene) {
        ...
        scene.executeWhenReady(function () {
            ...
            var videoTexture = new BABYLON.VideoTexture("video", ["proteinvr_baked.mp4"], scene, true);
            var nonVideoTexture = new BABYLON.Texture("proteinvr_baked_texture34.png", scene);
            var useVideoTexture = true;
            mat.emissiveTexture = videoTexture;
            mat.backFaceCulling = false;
            // sphere.sideOrientation = BABYLON.Mesh.BACKSIDE;
